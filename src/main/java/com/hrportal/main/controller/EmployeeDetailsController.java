...
public class EmployeeDetailsController {
	...
	@RequestMapping(value = "employeedetails/interviewer/{jobId}", method = RequestMethod.GET)
	public @ResponseBody List<EmployeeDetails> getInterviewerByTechnicalSkills(@PathVariable String jobId){
		System.out.println(jobId);
		return employeeDetailsServiceInterface.getInterviewerByTechnicalSkills(jobId);
	}
